...
def main():
    ...
    arch.append(
        to_SELayer("se_1", "", "(0,0,0)", "(conv_5-east)", height=height, depth=height,
                width=2))

    arch.append(
        to_ReLu("relu_7", "", "(0,0,0)", "(se_1-east)", height=height, depth=height,
                width=2))
    ...
    arch.append(
        to_SELayer("se_2", "", "(0,0,0)", "(conv_10-east)", height=height, depth=height,
                   width=2))
    arch.append(
        to_ReLu("relu_12", "", "(0,0,0)", "(se_2-east)", height=height, depth=height,
                width=2))

    arch.append(to_skip("relu_7", "se_2"))
    arch.append(
    ...
    arch.append(
        to_SELayer("se_3", "", "(0,0,0)", "(conv_15-east)", height=height, depth=height,
                   width=2))
    ...
    arch.append(
        to_ReLu("relu_18", "", "(0,0,0)", "(se_3-east)", height=height, depth=height,
                width=2))



    arch.append(to_bottomskip("relu_12", "conv_16", pos=1.25))
    arch.append(to_topskip("conv_16", "se_3", pos=1.25))

    arch.append(to_Sum("sum_17", "(2.2,-5,0)", "(conv_16-east)"))
    ...
    arch.append(
        to_SELayer("se_4", "", "(0,0,0)", "(conv_21-east)", height=height, depth=height,
                   width=2))
    arch.append(
        to_ReLu("relu_23", "", "(0,0,0)", "(se_4-east)", height=height, depth=height,
                width=2))

    arch.append(to_skip("relu_18", "se_4"))
    ...
    arch.append(
        to_SELayer("se_5", "", "(0,0,0)", "(conv_26-east)", height=height, depth=height,
                   width=2))
    ...
    arch.append(
        to_ReLu("relu_29", "", "(0,0,0)", "(se_5-east)", height=height, depth=height,
                width=2))

    arch.append(to_bottomskip("relu_23", "conv_27", pos=1.25))
    arch.append(to_topskip("conv_27", "se_5", pos=1.25))

    arch.append(to_Sum("sum_28", "(2.4,-2.5,0)", "(conv_27-east)"))
    ...
    arch.append(
        to_SELayer("se_6", "", "(0,0,0)", "(conv_32-east)", height=height, depth=height,
                   width=2))
    arch.append(
        to_ReLu("relu_34", "", "(0,0,0)", "(se_6-east)", height=height, depth=height,
                width=2))

    arch.append(to_skip("relu_29", "se_6"))
    ...
    arch.append(
        to_Conv("conv_37", "", n_filters, offset="(0,0,0)", to="(relu_36-east)", height=height, depth=height,
                width=3 * num_filters))
    arch.append(
        to_SELayer("se_7", "", "(0,0,0)", "(conv_37-east)", height=height, depth=height,
                   width=2))
    ...
    arch.append(
        to_ReLu("relu_40", "", "(0,0,0)", "(se_7-east)", height=height, depth=height,
                width=2))

    arch.append(to_bottomskip("relu_34", "conv_38", pos=1.25))
    arch.append(to_topskip("conv_38", "se_7", pos=1.25))
    arch.append(to_Sum("sum_39", "(3.75,-1.,0)", "(conv_38-east)"))
    ...
    arch.append(
        to_Conv("conv_43", "", n_filters, offset="(0,0,0)", to="(relu_42-east)", height=height, depth=height,
                width=3 * num_filters))
    arch.append(
        to_SELayer("se_8", "", "(0,0,0)", "(conv_43-east)", height=height, depth=height,
                   width=2))
    arch.append(
        to_ReLu("relu_45", "", "(0,0,0)", "(se_8-east)", height=height, depth=height,
                width=2))

    arch.append(to_skip("relu_40", "se_8"))
