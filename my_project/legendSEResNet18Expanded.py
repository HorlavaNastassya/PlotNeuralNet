...
def main():
    ...
    arch.append(
        to_SELayer("se_1", "SE block", "(0.5,0,0)", "(pool_1-east)", height=height, depth=0,
                   width=width))

    arch.append(
        to_GlobalPool("GlobPool", offset="(0.5,0,0)", to="(se_1-east)", height=height, depth=0,
    ...
    arch.append(to_Dropout("dropout_1", "Dropout", "(0.5,0,0)", "(flatten_1-east)", height=height, depth=0,
                           width=width))

    arch.append(to_SoftMax("soft1", "Linear FC", "(0.5,0,0)", "(dropout_1-east)", height=height, depth=0,
                           width=width), )
